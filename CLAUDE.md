...
- `tests/timer.test.ts` — 81 e2e tests (Playwright)
...
- Desktop keyboard shortcuts: Space (play/pause/resume), Left/Right (skip), F (fullscreen), Esc (close overlay/home when finished), ? (shortcuts help modal)
